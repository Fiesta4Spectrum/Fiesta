...
#     if 'new_global' in content:
#         contentDup.pop('new_global') # remove the global_model cause it is lazy generated
#     if 'local_list' in content:
#         contentDup.pop('local_list') # transaction is too large to hash we will use its hash to generate the block's hash
#     if 'hash' in content:
